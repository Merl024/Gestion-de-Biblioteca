...
public class SistemaGestionBiblioteca {
    public static void main(String[] args) {
        ...
        System.out.println("¿Documento eliminado? " + biblioteca.eliminarDocumento("004"));
        System.out.println("---------------------------------");

        // Encontrar documentos prestados
        System.out.println("Libro prestado a " + estudiante2.getNombre() + " " + biblioteca.encontrarDocumentosPrestadosA(estudiante2));
        System.out.println("---------------------------------");
        ...
        System.out.println("\nEstado final de la biblioteca (Documentos disponibles):");
        for (Documento doc : biblioteca.getDocumentos()) {  // Necesitas un getter para 'documentos' en Biblioteca
            if (doc.isDisponible()) {
